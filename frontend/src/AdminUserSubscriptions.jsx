    ...
    <div className="min-h-screen bg-gradient-to-r from-[#f3f8ea] to-[#e9f5d0] p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
          <div>
            <h1 className="text-4xl font-bold text-slate-900">User Subscriptions</h1>
            <p className="text-slate-600 mt-2">Manage all user subscriptions with full monitoring and control</p>
          </div>
          <button
